...
def parse_args():
    ...
    parser.add_argument('--model', default='vgg8', help='vgg8|vgg11|vgg16|vgg19|DenseNet40|resnet18|resnet50|swin_t')
    parser.add_argument('--data_path', default='/u/home/asaha/datasets/', help='path to saved datasets')
    ...
    parser.add_argument('--ppa', type=int, default=0, help='run power, performance, and area analysis (C++)')
    ...
    parser.add_argument('--bitcell', type=int, default=2, help='cell precision (e.g. 4-bit/cell)')
    parser.add_argument('--mem_type', type=str, default='resistive', help='memory cell type: resisitive | capacitive')
    parser.add_argument('--off_state', type=float, default=5.45476e-3, help='device off state (conductance (S) or capacitance (F))')
    parser.add_argument('--on_state', type=float, default=10.9272e-3, help='device on conductance')
    ...
    parser.add_argument('--v', type=float, default=0.000, help='drift coefficient')
